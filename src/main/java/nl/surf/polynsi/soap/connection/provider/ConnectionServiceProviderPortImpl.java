...
public class ConnectionServiceProviderPortImpl implements ConnectionProviderPort {
    ...
    private ServiceExceptionType notImplementedServiceException(String providerNSA, String feature) {
        ...
        serviceException.setText("NOT_IMPLEMENTED: Requested feature has not been implemented (%s)".formatted(feature));
        return serviceException;
    }
    ...
    private ServiceExceptionType genericInternalServiceException(String providerNSA, String connectionId, String text) {
        ...
        serviceException.setText(
                "GENERIC_INTERNAL_ERROR: An internal error has caused a message processing failure (%s)"
                        .formatted(text));
        return serviceException;
    }
    ...
    @Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2020-04-27T16:21:07.875+02:00")
    public void provision(String connectionId, jakarta.xml.ws.Holder<CommonHeaderType> soapHeader)
        ...
        try {
            ...
            GenericRequest pbProvisionRequest = GenericRequest.newBuilder()
                    .setHeader(pbHeader)
                    .setConnectionId(connectionId)
                    .build();

            LOG.finer("Built protobuf message `GenericRequest`:\n" + pbProvisionRequest);
            GenericAcknowledgment pbProvisionResponse = connectionProviderStub.provision(pbProvisionRequest);
    ...
    public QuerySummaryConfirmedType querySummarySync(
            QueryType querySummarySync, jakarta.xml.ws.Holder<CommonHeaderType> soapHeader) throws Error {
        ...
        if (querySummarySync.getIfModifiedSince() != null)
            LOG.fine("if modified since %s"
                    .formatted(querySummarySync.getIfModifiedSince().format(DateTimeFormatter.ISO_OFFSET_DATE_TIME)));
        try {
            Header pbHeader = toProtobuf(soapHeader.value);
            ...
            QueryConfirmedRequest pbQueryConfirmedRequest =
                    connectionProviderStub.querySummarySync(pbQueryReguestBuilder.build());
            ...
            addHeaders(soapHeader.value);
            throw new Error(
                    ex.toString(), genericInternalError(soapHeader.value.getProviderNSA(), null, ex.toString()));
        }
    }

    @Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2020-04-27T16:21:07.875+02:00")
    public GenericAcknowledgmentType queryRecursive(
            QueryType queryRecursive, jakarta.xml.ws.Holder<CommonHeaderType> soapHeader) throws ServiceException {
        ...
        if (queryRecursive.getIfModifiedSince() != null)
            LOG.fine("if modified since %s"
                    .formatted(queryRecursive.getIfModifiedSince().format(DateTimeFormatter.ISO_OFFSET_DATE_TIME)));
        try {
            Header pbHeader = toProtobuf(soapHeader.value);
            QueryRequest.Builder pbQueryReguestBuilder = QueryRequest.newBuilder();
            pbQueryReguestBuilder.setHeader(pbHeader);
            if (queryRecursive.getIfModifiedSince() != null) {
                pbQueryReguestBuilder.setIfModifiedSince(Timestamps.parse(
                        queryRecursive.getIfModifiedSince().format(DateTimeFormatter.ISO_OFFSET_DATE_TIME)));
            }
            ...
            LOG.finer("Built protobuf message `QueryRequest`:\n" + pbQueryReguestBuilder.build());
            GenericAcknowledgment pbQueryResponse =
                    connectionProviderStub.queryRecursive(pbQueryReguestBuilder.build());
            ...
            if (pbQueryResponse.hasServiceException()) {
                addHeaders(soapHeader.value);
                throw new ServiceException(
                        pbQueryResponse.getServiceException().getText(), toSoap(pbQueryResponse.getServiceException()));
            }
            var objectFactory = new nl.surf.polynsi.soap.connection.types.ObjectFactory();
    ...
    public void reserveCommit(String connectionId, jakarta.xml.ws.Holder<CommonHeaderType> soapHeader)
            throws ServiceException {
        LOG.info("SOAP->gRPC reserveCommit from %s".formatted(soapHeader.value.getRequesterNSA()));
        LOG.fine("connection ID %s".formatted(connectionId));
        try {
            Header pbHeader = toProtobuf(soapHeader.value);
            GenericRequest pbReserveCommitRequest = GenericRequest.newBuilder()
                    .setHeader(pbHeader)
                    .setConnectionId(connectionId)
                    .build();

            LOG.finer("Built protobuf message `GenericRequest`:\n" + pbReserveCommitRequest);
            GenericAcknowledgment pbReserveCommitResponse =
                    connectionProviderStub.reserveCommit(pbReserveCommitRequest);
    ...
    public void queryNotification(
            ...
            jakarta.xml.ws.Holder<CommonHeaderType> soapHeader)
            throws ServiceException {
        LOG.info("SOAP->gRPC queryNotification from %s".formatted(soapHeader.value.getRequesterNSA()));
        LOG.fine("connection ID %s".formatted(connectionId));
        if (startNotificationId != null) LOG.fine("start notification ID %d".formatted(startNotificationId));
        if (endNotificationId != null) LOG.fine("end notification ID %d".formatted(endNotificationId));
        try {
            Header pbHeader = toProtobuf(soapHeader.value);
            ...
            if (endNotificationId != null) pbQueryNotificationReguestBuilder.setEndNotificationId(endNotificationId);
            LOG.finer(
                    "Built protobuf message `QueryNotificationRequest`:\n" + pbQueryNotificationReguestBuilder.build());
            GenericAcknowledgment pbQueryNotificationResponse =
                    connectionProviderStub.queryNotification(pbQueryNotificationReguestBuilder.build());
    ...
    @Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2020-04-27T16:21:07.875+02:00")
    public void terminate(String connectionId, jakarta.xml.ws.Holder<CommonHeaderType> soapHeader)
            throws ServiceException {
        LOG.info("SOAP->gRPC terminate from %s".formatted(soapHeader.value.getRequesterNSA()));
        LOG.fine("connection ID %s".formatted(connectionId));
        try {
            Header pbHeader = toProtobuf(soapHeader.value);
            GenericRequest pbTerminateRequest = GenericRequest.newBuilder()
                    .setHeader(pbHeader)
                    .setConnectionId(connectionId)
                    .build();

            LOG.finer("Built protobuf message `GenericRequest`:\n" + pbTerminateRequest);
            GenericAcknowledgment pbTerminateResponse = connectionProviderStub.terminate(pbTerminateRequest);
    ...
    public void reserve(
            jakarta.xml.ws.Holder<String> connectionId,
            String globalReservationId,
            String description,
            ReservationRequestCriteriaType soapCriteria,
            jakarta.xml.ws.Holder<CommonHeaderType> soapHeader)
            throws ServiceException {
        LOG.info("SOAP->gRPC reserve from %s".formatted(soapHeader.value.getRequesterNSA()));
        if (connectionId.value != null) LOG.fine("connection ID %s".formatted(connectionId.value));
        LOG.fine("global reservation ID %s".formatted(globalReservationId));
        LOG.fine("description %s".formatted(description));
        LOG.fine("service type %s".formatted(soapCriteria.getServiceType()));
        if (soapCriteria.getVersion() != null) LOG.fine("version %d".formatted(soapCriteria.getVersion()));

        try {
            Header pbHeader = toProtobuf(soapHeader.value);
            ReserveRequest.Builder pbReserveRequestBuilder =
                    ReserveRequest.newBuilder().setHeader(pbHeader);
            ...
            ReservationRequestCriteria.Builder pbReservationRequestCriteriaBuilder =
                    ReservationRequestCriteria.newBuilder();
            ...
            if (soapCriteria.getSchedule() != null) {
                ...
                if (soapCriteria.getSchedule().getStartTime() != null) {
                    LOG.fine("start time %s"
                            .formatted(soapCriteria
                                    .getSchedule()
                                    .getStartTime()
                                    .format(DateTimeFormatter.ISO_OFFSET_DATE_TIME)));
                    pbScheduleBuilder.setStartTime(Timestamps.parse(
                            soapCriteria.getSchedule().getStartTime().format(DateTimeFormatter.ISO_OFFSET_DATE_TIME)));
                }
                if (soapCriteria.getSchedule().getEndTime() != null) {
                    LOG.fine("end time %s"
                            .formatted(soapCriteria
                                    ...
                                    .getEndTime()
                                    .format(DateTimeFormatter.ISO_OFFSET_DATE_TIME)));
                    pbScheduleBuilder.setEndTime(Timestamps.parse(
                            soapCriteria.getSchedule().getEndTime().format(DateTimeFormatter.ISO_OFFSET_DATE_TIME)));
                }
                ...
                */
                if (elem instanceof JAXBElement<?> bodyElem) {
                    if (bodyElem.getValue() instanceof P2PServiceBaseType) {
                        ...
                        PointToPointService.Builder pbP2PServiceBuilder =
                                PointToPointService.newBuilder().setCapacity(soapP2PService.getCapacity());
                        ...
                        */
                        ...
                        if (soapP2PService.getEro() != null) {
                            List<OrderedStpType> soapOrderedSTP =
                                    soapP2PService.getEro().getOrderedSTP();
                            soapOrderedSTP.sort(Comparator.comparing(OrderedStpType::getOrder));
                            pbP2PServiceBuilder.addAllEros(soapOrderedSTP.stream()
                                    .map(OrderedStpType::getStp)
            ...
            throw new ServiceException(
                    ex.toString(),
                    genericInternalServiceException(
                            soapHeader.value.getProviderNSA(), connectionId.value, ex.toString()));
        }
    }

    @Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2020-04-27T16:21:07.875+02:00")
    public java.util.List<QueryResultResponseType> queryResultSync(
            String connectionId,
            Long startResultId,
            Long endResultId,
            jakarta.xml.ws.Holder<CommonHeaderType> soapHeader)
        ...
        LOG.fine("connection ID %s".formatted(connectionId));
        if (startResultId != null) LOG.fine("start result ID %d".formatted(startResultId));
        if (endResultId != null) LOG.fine("end result ID %d".formatted(endResultId));
        try {
            Header pbHeader = toProtobuf(soapHeader.value);
            ...
            if (startResultId != null) pbQueryResultReguestBuilder.setStartResultId(startResultId);
            if (endResultId != null) pbQueryResultReguestBuilder.setEndResultId(endResultId);
            ...
            QueryResultConfirmedRequest pbQueryResultConfirmedRequest =
                    connectionProviderStub.queryResultSync(pbQueryResultReguestBuilder.build());
    ...
    @Generated(value = "org.apache.cxf.tools.wsdlto.WSDLToJava", date = "2020-04-27T16:21:07.875+02:00")
    public void release(String connectionId, jakarta.xml.ws.Holder<CommonHeaderType> soapHeader)
            throws ServiceException {
        LOG.info("SOAP->gRPC release from %s".formatted(soapHeader.value.getRequesterNSA()));
        LOG.fine("connection ID %s".formatted(connectionId));
        try {
            Header pbHeader = toProtobuf(soapHeader.value);
            GenericRequest pbReleaseRequest = GenericRequest.newBuilder()
                    .setHeader(pbHeader)
                    .setConnectionId(connectionId)
                    .build();

            LOG.finer("Built protobuf message `GenericRequest`:\n" + pbReleaseRequest);
            GenericAcknowledgment pbReleaseResponse = connectionProviderStub.release(pbReleaseRequest);
    ...
    public void reserveAbort(String connectionId, jakarta.xml.ws.Holder<CommonHeaderType> soapHeader)
            throws ServiceException {
        LOG.info("SOAP->gRPC reserveAbort from %s".formatted(soapHeader.value.getRequesterNSA()));
        LOG.fine("connection ID %s".formatted(connectionId));
        try {
            Header pbHeader = toProtobuf(soapHeader.value);
            GenericRequest pbReserveAbortRequest = GenericRequest.newBuilder()
                    .setHeader(pbHeader)
                    .setConnectionId(connectionId)
                    .build();

            LOG.finer("Built protobuf message `GenericRequest`:\n" + pbReserveAbortRequest);
            GenericAcknowledgment pbReserveAbortResponse = connectionProviderStub.reserveAbort(pbReserveAbortRequest);
    ...
    public GenericAcknowledgmentType querySummary(
            QueryType querySummary, jakarta.xml.ws.Holder<CommonHeaderType> soapHeader) throws ServiceException {
        LOG.info("SOAP->gRPC querySummary from %s".formatted(soapHeader.value.getRequesterNSA()));
        for (String connectionId : querySummary.getConnectionId()) LOG.fine("connection ID %s".formatted(connectionId));
        for (String globalReservationId : querySummary.getGlobalReservationId())
            LOG.fine("global reservation ID %s".formatted(globalReservationId));
        if (querySummary.getIfModifiedSince() != null)
            LOG.fine("if modified since %s"
                    .formatted(querySummary.getIfModifiedSince().format(DateTimeFormatter.ISO_OFFSET_DATE_TIME)));
        try {
            Header pbHeader = toProtobuf(soapHeader.value);
            QueryRequest.Builder pbQueryReguestBuilder = QueryRequest.newBuilder();
            pbQueryReguestBuilder.setHeader(pbHeader);
            if (querySummary.getIfModifiedSince() != null) {
                pbQueryReguestBuilder.setIfModifiedSince(Timestamps.parse(
                        querySummary.getIfModifiedSince().format(DateTimeFormatter.ISO_OFFSET_DATE_TIME)));
            }
            ...
            LOG.finer("Built protobuf message `QueryRequest`:\n" + pbQueryReguestBuilder.build());
            GenericAcknowledgment pbQueryResponse = connectionProviderStub.querySummary(pbQueryReguestBuilder.build());
            // check the protobuf QueryResponse and either return a SOAP ServiceException or the generic Ack
            if (pbQueryResponse.hasServiceException()) {
                addHeaders(soapHeader.value);
                throw new ServiceException(
    ...
    public void queryResult(
        ...
        LOG.fine("connection ID %s".formatted(connectionId));
        if (startResultId != null) LOG.fine("start result ID %d".formatted(startResultId));
        if (endResultId != null) LOG.fine("end restult ID %d".formatted(endResultId));
        try {
            Header pbHeader = toProtobuf(soapHeader.value);
            QueryResultRequest.Builder pbQueryResultReguestBuilder = QueryResultRequest.newBuilder();
            pbQueryResultReguestBuilder.setHeader(pbHeader);
            ...
            if (endResultId != null) pbQueryResultReguestBuilder.setEndResultId(endResultId);
            LOG.finer("Built protobuf message `QueryResultRequest`:\n" + pbQueryResultReguestBuilder.build());
            GenericAcknowledgment pbQueryResultResponse =
                    connectionProviderStub.queryResult(pbQueryResultReguestBuilder.build());
    ...
    public QueryNotificationConfirmedType queryNotificationSync(
            QueryNotificationType queryNotificationSync, jakarta.xml.ws.Holder<CommonHeaderType> soapHeader)
            throws Error {
        ...
        try {
            ...
            if (queryNotificationSync.getStartNotificationId() != null)
                pbQueryNotificationReguestBuilder.setStartNotificationId(
            ...
            LOG.finer(
                    "Built protobuf message `QueryNotificationReguest`:\n" + pbQueryNotificationReguestBuilder.build());
            // queryNotificationSync returns a QueryNotificationConfirmedRequest bypassing the generic Response messages
            QueryNotificationConfirmedRequest pbQueryConfirmedRequest =
                    connectionProviderStub.queryNotificationSync(pbQueryNotificationReguestBuilder.build());
            // the pbQueryConfirmedRequest does not have a service exception field,
            // it is assumed that the query operations does not cause exceptions in SuPA
